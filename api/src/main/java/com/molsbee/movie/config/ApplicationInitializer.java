...
import com.molsbee.movie.security.config.SecurityConfig;
...
public class ApplicationInitializer extends SpringServletContainerInitializer implements WebApplicationInitializer {

    @Override
    public void onStartup(ServletContext servletContext) throws ServletException {
        AnnotationConfigWebApplicationContext rootContext = new AnnotationConfigWebApplicationContext();
        rootContext.register(ApplicationConfig.class, DispatcherConfig.class, SecurityConfig.class);
